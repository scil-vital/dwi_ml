...
def add_dataset_args(p: argparse.ArgumentParser, with_volumes: bool = False):
    """
    ...
    if with_volumes:
        dataset_group.add_argument(
            ...
            help="Relevant only if lazy data is used. Size of the cache in "
                 ...
                 "NOTE: Real \n cache size will actually be larger depending "
                 "on use;\nthe training, validation and testing sets each "
                 "have their cache. [1]")
    dataset_group.add_argument(
